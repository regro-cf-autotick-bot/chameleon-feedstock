...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chameleon-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15561&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chameleon-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chameleon` can be installed with:

```
conda install chameleon
```

It is possible to list all of the versions of `chameleon` available on your platform with:
